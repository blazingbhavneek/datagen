...
from agents.nodes import CustomLLMWithTools, OutputMode
...
llm_with_tools = CustomLLMWithTools(
    mode=OUTPUT_MODE, base_url=BASE_URL, model_name=MODEL_NAME, tools=tools
)
...
"""
    ...
    initial_state = {"messages": [HumanMessage(content=query)], "iteration_count": 0}
